                ...
                <div className="flex flex-col gap-5 px-7 py-5">
                    <div className="flex lg:flex-row md:flex-row sm:flex-col justify-between">
                        ...
                        <div className="h-10 flex gap-3">
                            <button className="h-full group flex items-center rounded-lg border border-[#D5D7DA] lg:px-[14px] sm:px-[8px] py-[10px] gap-1 shadow-[0_1px_2px_0_#0A0D120D] group-hover:shadow-[inset_0_-2px_0_0_#0A0D120D]"><HiOutlineRefresh /> Refresh All</button>
                            <button className="h-full flex items-center rounded-lg border border-[#D5D7DA] lg:px-[14px] sm:px-[8px] py-[10px] gap-1 text-white bg-[#1570EF] border-[#FFFFFF1F] shadow-[#0A0D120D] group-hover:drop-shadow hover:shadow group-hover:shadow-[inset_0_-2px_0_0_#0A0D120D] shadow-[inset_0_0_0_-1px_#0A0D122E]"><HiOutlinePlus /> Add Repository</button>
                        </div>
                    </div>
